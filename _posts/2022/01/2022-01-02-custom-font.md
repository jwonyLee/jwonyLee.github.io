...
subtitle: 접근성도 같이 지원하기
categories: iOS
tags: [iOS, 폰트, 접근성, "Dynamic Type"]
published: true
---
...
![폰트 파일](/assets/image/custom-font/files.png)

적당한 위치에 폰트 파일을 추가한다.

`Info.plist`에 `Fonts provided by application` 항목을 추가한다. 그리고 하위 항목에 추가한 파일이름을 추가한다.

![Info.plist](/assets/image/custom-font/info-plist.png)
...
![dynamic type 적용 사진](/assets/image/custom-font/dynamic-type.gif)
